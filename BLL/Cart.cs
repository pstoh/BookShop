...
namespace BookShop.BLL
{
	...
	{
		private readonly BookShop.DAL.Cart dal=new BookShop.DAL.Cart();
		public Cart()
		{}
		#region  BasicMethod
		...
		public Model.Cart GetCart(int userId, int bookId)
		{
			return dal.GetCart(userId, bookId);
		}

		public List<Model.Cart> GetModelList(int userId)
		{
