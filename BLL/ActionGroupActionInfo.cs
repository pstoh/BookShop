...
{
	/// <summary>
	/// ActionGroupActionInfo
	/// </summary>
	public partial class ActionGroupActionInfo
	{
		private readonly BookShop.DAL.ActionGroupActionInfo dal=new BookShop.DAL.ActionGroupActionInfo();
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(BookShop.Model.ActionGroupActionInfo model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(BookShop.Model.ActionGroupActionInfo model)
		{
		...
		public bool Delete(int ActionGroup_ID,int ActionInfo_ID)
		{
			...
			return dal.Delete(ActionGroup_ID,ActionInfo_ID);
		}
