<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BookList.aspx.cs" Inherits="BookShop.Web.BookList" MasterPageFile="~/MainMaster/MasterPage.Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <%foreach(Books bookModel in ProductList){%>
<TABLE>
                    <TBODY>
                    <TR>
                      ...
                      <TD style="FONT-SIZE: small; COLOR: red" width=650><A 
                        ...
                        href="BookDetail_<%=bookModel.Id%>.aspx" target="_blank" 
                        name="link_prd_name">
    ...
    <%} %>
    <div class="page_nav">
        <%=BookShop.Common.PageBarHelper.GetPageBar(PageIndex,PageCount) %>
    </div>
